...
class Result(models.Model):
    ...
    suggest_1 = models.ForeignKey(Company, on_delete=models.CASCADE, to_field='company_id', related_name="suggest_1", db_column='suggest_1')
    suggest_2 = models.ForeignKey(Company, on_delete=models.CASCADE, to_field='company_id', related_name="suggest_2", db_column='suggest_2')
    suggest_3 = models.ForeignKey(Company, on_delete=models.CASCADE, to_field='company_id', related_name="suggest_3", db_column='suggest_3')
